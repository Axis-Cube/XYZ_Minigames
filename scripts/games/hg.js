...
export async function upgradeItem(player) {
    ...
    try {
        ...
        //Errors block
        if (upgradesBlocked.includes(item_properties.type)) {
            throw new Error('12_0');
        }
        if (item_properties.type == undefined) {
            throw new Error('12_1');
        }
        //
